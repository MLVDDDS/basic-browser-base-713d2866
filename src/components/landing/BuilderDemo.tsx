    ...
    <div className="rounded-xl border border-border bg-card overflow-hidden shadow-2xl shadow-primary/5 w-full max-w-[600px]">
      ...
      <div className="flex h-[280px] sm:h-[340px] md:h-[380px]">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex-1 bg-gradient-to-br from-muted/20 to-muted/40 flex items-center justify-center overflow-hidden relative">
            {/* Scaled inner wrapper to guarantee fit */}
              ...
              <AnimatePresence mode="wait">
                {viewType === 'website' ? (
                  <motion.div 
                    ...
                    style={{
                      width: deviceSize === 'mobile' ? '90px' : deviceSize === 'tablet' ? '140px' : '220px',
                    ...
                    <div className="p-2">
                      <div className="flex items-center gap-1 mb-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="h-1 w-8 bg-foreground/20 rounded mb-0.5" />
                          <div className="h-0.5 w-5 bg-muted-foreground/20 rounded" />
                        </div>
                      </div>
                      <div className="h-1 w-3/4 bg-foreground/20 rounded mb-1" />
                      <div className="h-0.5 w-full bg-muted-foreground/20 rounded mb-0.5" />
                      <div className="h-0.5 w-2/3 bg-muted-foreground/20 rounded mb-1.5" />
                      <div className="h-4 w-14 bg-primary rounded shadow-lg shadow-primary/30 flex items-center justify-center">
                        <span className="text-[6px] text-primary-foreground font-medium">Кнопка</span>
                      </div>
                    </div>
                  </motion.div>
                ) : (
