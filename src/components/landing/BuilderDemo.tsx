              ...
              <AnimatePresence mode="wait">
                {viewType === 'website' ? (
                  <motion.div 
                    ...
                    className="bg-background rounded-lg sm:rounded-xl border border-border shadow-xl origin-center max-h-full"
                    style={{
                      width: deviceSize === 'mobile' ? '90px' : deviceSize === 'tablet' ? '140px' : '100%',
                  ...
                  >
                    ...
                    <div className="p-1.5 sm:p-4">
                      <div className="flex items-center gap-1 sm:gap-2 mb-1 sm:mb-3">
                        <div className="w-4 h-4 sm:w-8 sm:h-8 rounded sm:rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                          <Globe className="w-2 h-2 sm:w-4 sm:h-4 text-primary" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="h-[3px] sm:h-1.5 w-7 sm:w-16 bg-foreground/20 rounded mb-0.5" />
                          <div className="h-[2px] sm:h-1 w-5 sm:w-10 bg-muted-foreground/20 rounded" />
                        </div>
                      </div>
                      <div className="h-[3px] sm:h-2.5 w-3/4 bg-foreground/20 rounded mb-1 sm:mb-2" />
                      <div className="h-[2px] sm:h-1.5 w-full bg-muted-foreground/20 rounded mb-0.5" />
                      <div className="h-[2px] sm:h-1.5 w-2/3 bg-muted-foreground/20 rounded mb-1 sm:mb-3" />
                      <div className="h-3.5 sm:h-7 w-12 sm:w-24 bg-primary rounded sm:rounded-lg shadow-lg shadow-primary/30 flex items-center justify-center">
                        <span className="text-[5px] sm:text-[9px] text-primary-foreground font-medium">Кнопка</span>
                      </div>
                    </div>
                  </motion.div>
                ) : (
