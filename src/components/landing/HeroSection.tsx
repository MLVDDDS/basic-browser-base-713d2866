...
const BuilderDemo = lazy(() =>
  import('./BuilderDemo').then((module) => ({ default: module.BuilderDemo }))
);

function DemoFallback() {
  return <div className="h-[280px] sm:h-[340px] md:h-[380px] w-full max-w-[600px] rounded-xl border border-border bg-card" aria-hidden="true" />;
}
