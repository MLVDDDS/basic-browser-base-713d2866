...
const MODE_CONFIG: Record<PipelineMode, { 
  ...
  light: { 
    ...
    description: 'Quick task with fast-tier model'
  },
  low: { 
    label: 'LOW', 
    color: 'text-blue-600', 
    bgColor: 'bg-blue-500/10 border-blue-500/20',
    description: 'Standard task with balanced-tier model'
  },
  medium: { 
    label: 'MEDIUM', 
  ...
  high: { 
    ...
    description: 'Multi-model orchestration with premium-tier routing'
  },
};
